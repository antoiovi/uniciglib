...
public double CondicTermica(){
	...
	**/
	return comb.lambdaA(temperatura);
	}
...
public double ViscositaDinamica(){
	...
	**/
	return comb.viscDin(temperatura);
}
 ...
 */
 ...
 public double CostElasticita() {
  return R;
	...
	**/
	public double PparzialeH2o_from_Paria(double PL){
	...
	* @return PD pressione parziale del vapore acqueo in Pa
	**/
	public double PparzialeH2o_from_Trugiada(double tp){
